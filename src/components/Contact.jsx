...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_3lbnoua', 'template_rc33df7', e.target, 
      'fN_mVUWCo2pC1uHpa',
      )
      .then(
        () => {
        ...
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
            ...
            <div className='flex justify-center items-center'>
                <form onSubmit={sendEmail} className='flex flex-col w-full md:w-1/2' >
                    <input id="name" type="text" name="name" placeholder="Enter your name" className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
                    <input id="emailFrom" type="text" name="email_from" placeholder="Enter your email" className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none'/>
                    <textarea id="message" name="message" rows="10" placeholder="Enter your message" className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
